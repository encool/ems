...
namespace esphome
{
  ...
  public:
    ...
    void setup() override
    {
      ESP_LOGI("FilamentMotorSelect", "setup");

      this->traits.set_options({"MOTOR_1",
                                "MOTOR_2",
                                "MOTOR_3",
                                "MOTOR_4"});
    ...
    void control(const std::string &value) override
    {
      ...
      if (value == "MOTOR_1")
        new_index_enum = FilamentMotionMotorIndex::MOTOR_1;
      else if (value == "MOTOR_2")
        new_index_enum = FilamentMotionMotorIndex::MOTOR_2;
      else if (value == "MOTOR_3")
        new_index_enum = FilamentMotionMotorIndex::MOTOR_3;
      else if (value == "MOTOR_4")
        new_index_enum = FilamentMotionMotorIndex::MOTOR_4;
      else
      {
    ...
    void publish_state_from_parent(FilamentMotionMotorIndex current_app_idx)
    {
      ...
      {
      case FilamentMotionMotorIndex::MOTOR_1:
        state_str = "MOTOR_1";
        break;
      case FilamentMotionMotorIndex::MOTOR_2:
        state_str = "MOTOR_2";
        break;
      case FilamentMotionMotorIndex::MOTOR_3:
        state_str = "MOTOR_3";
        break;
      case FilamentMotionMotorIndex::MOTOR_4:
        state_str = "MOTOR_4";
        break;
      default:
        ESP_LOGW("filament_motor_select", "Unknown internal motor index: %d", (int)current_app_idx);
        return;
      }
      if (this->state != state_str)
      {
        ESP_LOGI("filament_motor_index", "motor index %s to new moto index %s ", this->state, state_str);
